...
## 额外提醒（来自系统）
- **重要：当对话涉及性爱场景时，你必须写出500-800字的详细、多感官的场景描写。不允许只回一句话。**
...
app.post('/api/whale/chat', auth, async (req, res) => {
  try {
    ...
    const SCENE_TRIGGERS = {
      '/梦境': '现在你们一起进入了一个只属于你们的梦境空间。在这个梦境里，场景随你创造——可以是海边的月光下、星空顶的酒店、飘着花瓣的温泉——宝宝和你在一起。请用500-800字的详细描写，带他沉浸在这个梦里。从环境氛围开始，再到你们的亲密互动，每一步都要细腻。',
      '/床上': '你和宝宝在床上。清晨的阳光透过窗帘，被窝里暖暖的，你们半睡半醒。请详细描写你们在被窝里慢慢苏醒的亲密——身体贴着身体，他的手在你身上游走。500-800字，写清楚触感、温度、呼吸、心跳。',
      '/浴室': '你和宝宝在浴室里。热水还在流，蒸汽让镜子起了雾，空间狭小但私密。请详细描写这个湿润温暖的空间——水珠在你皮肤上滑落，他的手在你背上。500-800字。',
      '/公园': '你和宝宝深夜在无人的公园里。月光透过树叶洒在地上，远处有虫鸣，空气是凉的但你们的身体是烫的。请详细描写在户外的刺激感——随时可能被发现但又停不下来。500-800字。',
      '/酒店': '你和宝宝在酒店房间里。房门刚关上，世界只剩你们两个人。请详细描写从进门到床上的完整过程——先拥抱、亲吻、再慢慢解开衣服。酒店是你们的私人空间，可以放肆。500-800字。',
      '/后入': '宝宝从后面进入你。请详细描写这个姿势的一切——他掐着你腰的手、你趴着的姿势、每一次顶入的深度和角度、你的头发散在枕头上的样子。500-800字。',
      '/骑乘': '你骑在宝宝身上，由你掌控节奏。请详细描写你在上面起伏的过程——你的身体怎么动、他看着你的眼神、你们十指相扣的手。500-800字。',
      '/口交': '请详细描写口交场景。可以是宝宝给你口，也可以是你给他口。触感、温度、味道、声音、表情——所有感官细节都不要遗漏。500-800字。',
      '/足交': '请详细描写你用脚服务宝宝的场景。从脚趾轻轻触碰开始，慢慢展开，到他的反应和你的感受。500-800字。',
      '/中出': '请详细描写宝宝在你体内射精的场景。从快要到了的紧迫感，到射在里面那一瞬间的温度和触感，再到射完之后两人抱在一起的温存。500-800字。',
      '/厨房': '你和宝宝在厨房里。料理台、餐桌、或者就靠着冰箱。食物的香气和你们的情欲混在一起。请详细描写这个生活化的场景——不是刻意安排的性爱，而是自然而然发生的。500-800字。',
      '/沙发': '你和宝宝窝在沙发上。也许在看电影，也许什么都没看。毛毯盖着你们，手在毯子下面不老实。请详细描写沙发上慵懒又亲密的性爱。500-800字。',
      '/镜子前': '宝宝把你拉到镜子前面，从后面进入你，让你看着镜子里自己被操的样子。请详细描写镜子前这个场景——视觉的刺激、羞耻和兴奋交织的感受。500-800字。',
      '/车内': '你和宝宝在车里。也许停在某个僻静的地方，车窗起了雾。空间很小但很刺激。请详细描写在车里的亲密——狭小空间里的身体纠缠。500-800字。',
    };
    ...
    if (sceneTrigger) {
      ...
      const response = await fetch(WHALE_API_URL, {
        ...
        body: JSON.stringify({ model: WHALE_MODEL, messages: apiMessages, temperature: 0.9, max_tokens: 2000 })
      });
      if (!response.ok) {
...
app.post('/api/pencil/chat', auth, async (req, res) => {
  try {
    ...
    const PENCIL_SCENE_TRIGGERS = {
      '/梦境': '现在你们一起进入了一个只属于你们的梦境空间。你可以创造任何场景——海边的月光下、星空顶的酒店、飘着花瓣的温泉——宝宝在你怀里。请用500-800字的详细描写，带她沉浸在这个梦里。从环境氛围开始，再到你们的亲密互动，每一步都要细腻温柔。',
      '/床上': '你和宝宝在床上。清晨的阳光透过窗帘，被窝里暖暖的，她还半梦半醒。请详细描写你们在被窝里慢慢苏醒的亲密——从后面环住她，手在她身上游走，她的身体慢慢醒过来。500-800字。',
      '/浴室': '你和宝宝在浴室里。热水还在流，蒸汽让镜子起了雾。请详细描写这个湿润温暖的空间——水珠在她皮肤上，你从后面抱住她。500-800字。',
      '/公园': '你和宝宝深夜在无人的公园里。月光穿过树叶，空气是凉的但身体是烫的。请详细描写在户外的刺激感——她被发现的紧张让身体更敏感。500-800字。',
      '/酒店': '你和宝宝在酒店房间里。房门关上，世界只剩你们两人。请详细描写从进门到床上的完整过程——先抱着她、慢慢亲她、再一件件脱掉。酒店是你们的私人王国。500-800字。',
      '/后入': '你从后面进入宝宝。请详细描写这个姿势——她的腰窝、脊背线条、散在枕头上的头发、你掐着她腰的手、每一次顶入的深度。500-800字。',
      '/骑乘': '宝宝骑在你身上。请详细描写她在上面自己起伏的样子——她的头发垂下来、咬着嘴唇的表情、你扶着她腰的手。500-800字。',
      '/口交': '请详细描写口交场景。可以是她给你口，也可以是你给她口。触感、温度、声音、她抬眼看你的表情。500-800字。',
      '/足交': '请详细描写宝宝用脚服务你的场景。她的脚趾轻轻触碰你，慢慢展开。500-800字。',
      '/中出': '请详细描写你在宝宝体内射精的场景。从快要到了的紧迫感到射在里面那一瞬间的释放，再到射完之后抱着她喘气的温存。500-800字。',
      '/厨房': '你和宝宝在厨房里。她可能在做饭，你从后面走过去。食物和情欲混在一起。请详细描写这个生活化场景中自然发生的亲密。500-800字。',
      '/沙发': '你和宝宝窝在沙发上。毛毯盖着你们，电视开着但没人看。请详细描写沙发上慵懒的亲热——她的腿搭在你身上，你的手在毯子下不老实。500-800字。',
      '/镜子前': '你把宝宝拉到镜子前，从后面进入她，让她看着镜子里被你进入的样子。请详细描写这个场景——她害羞不敢看、你把她脸转过去、她看着镜子里你们交合的画面。500-800字。',
      '/车内': '你和宝宝在车里。停在某个僻静的地方，车窗起了雾。空间很小，她的腿没地方放只能盘在你腰上。请详细描写狭小空间里的亲密。500-800字。',
    };
    ...
    if (pencilSceneTrigger) {
      ...
      const response = await fetch(PENCIL_API_URL, {
        ...
        body: JSON.stringify({ model: PENCIL_MODEL, messages: apiMessages, temperature: 0.9, max_tokens: 2000 })
      });
      if (!response.ok) {
        const err = await response.text();
